...
You can check out the code of these functions in its [Github repository](https://github.com/solmos/rfeb). Note that even though I am going to extract data from my league (LEB Oro), it can also be used to work with the other leagues organized FEB.
