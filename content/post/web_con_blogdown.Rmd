...
[^1]: En la documentación de Academic existe la posibilidad de crear la página web directamente con Netlify de modo que la publicación de la página resulta más sencilla. Sin embargo, con este método he tenido problemas para visualizar la página en RStudio.
